 ...
 *
 * La página de sector responde «cómo se integra IA en una plataforma
 * educativa». Es una consulta de investigación. El volumen comercial está un
 * escalón más abajo, en la tarea concreta —«tutor de IA acotado al curso»,
 * «corrección automática de exámenes con IA»—, que es lo que escribe alguien
 * que ya decidió que quiere resolver eso y está eligiendo a quién le compra.
 *
 ...
 * escribir ninguno.
 *
 * Hay un solo sector, con cuatro implementaciones. Multiplicar rubro × tarea
 * daría una granja de páginas que nadie puede escribir con sustancia: los
 * motores de respuesta no premian la cobertura, premian la página que puede
 * ser citada sin agregarle nada.
 */
