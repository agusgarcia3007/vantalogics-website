...
export const en: Dictionary = {
  ...
  hero: {
    ...
    diagramLabel: "What it looks like in practice",
    diagram: {
      title: "Architecture of a Vantalogics AI agent",
      desc: "Company inputs — email, CRM and documents — feed an agent that evaluates and logs every step. The agent takes action in your systems, routes uncertain cases to human review, and sends every trace to an observability layer.",
      email: "Email",
      crm: "CRM / ERP",
      docs: "Documents",
      agent: "Agent",
